  ...
  <div class="container--contact flex">
    ...
    <div class="container--text__contact flex">
      <div class="text">
        ...
        <div>
          <h2 ref="splitTwo">
            me an <a href="mailto: melvin.debot@hetic.net">email</a>
          </h2>
        </div>
      </div>
      <div class="text">
        <div>
          <h3 ref="splitThree">
            <a
              href="https://github.com/melvinDebot?tab=repositories"
              target="blank"
              >Github</a
            >
          </h3>
        ...
        <div>
          <h3 ref="splitFour">
            <a href="https://www.behance.net/melvindeboa7b2" target="blank"
              >Behance</a
            >
          </h3>
        </div>
  ...
  methods: {
    SplitTextAnimation() {
      gsap
        ...
        .timeScale(0.1)
        .fromTo(
          [this.$refs.splitOne, this.$refs.splitTwo],
          6,
          {
            y: 200,
            opacity: 0,
